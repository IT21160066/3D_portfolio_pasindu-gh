...
const renderContetnt = {
  1: (
    <h1 className="sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5">
      Hi, I am <span className="font-semibold">Pasindu</span>👋
      <br />A Software Engineer from Sri Lanka
    </h1>
  ),
  2: (
    <InfoBox
      text="Worked with many progrmming languages
...
const HomeInfo = ({ currentStage }) => {
  return renderContetnt[currentStage] || null;
};
